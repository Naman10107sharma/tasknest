...
<head>
    ...
    <title><?= htmlspecialchars($project['title']) ?> — TaskNest</title>
                ...
                <div class="card-body">
                    ...
                    <div class="progress" style="height:8px;border-radius:50px;">
                        <div class="progress-bar" style="width:<?= $pct ?>%;border-radius:50px;
                            background:linear-gradient(90deg,var(--teal-500),var(--accent-blue))!important;"></div>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="/php-pmapp/tasks/update_status.php" style="display:inline;">
                                            ...
                                            <input type="hidden" name="redirect" value="/php-pmapp/projects/view.php?id=<?= $id ?>">
                            ...
                            <?php if ($projectMembers->num_rows > 0): ?>
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div style="width:36px;height:36px;border-radius:50%;
                                                background:linear-gradient(135deg,var(--teal-500),var(--accent-blue));
