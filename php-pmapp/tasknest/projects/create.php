...
<head>
    ...
    <title>New Project — TaskNest</title>
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <?php if ($members && $members->num_rows > 0): ?>
                                        <div class="border rounded-3 p-3" style="max-height:200px;overflow-y:auto;background:var(--bg-elevated);border-color:var(--border-subtle)!important;">
