...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/auth/register.php" class="nav-link" target="_blank">
    ...
    <div class="sidebar-footer">
        ...
        <a href="/auth/logout.php" class="nav-link mt-2 text-danger" style="color:rgba(248,113,113,0.75)!important">
